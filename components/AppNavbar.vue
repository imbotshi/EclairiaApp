<template>
  <div class="fixed top-0 z-50 w-full h-[76px] bg-background">
    <div class="relative flex items-center justify-between w-full h-full">
      <!-- category -->
      <div
        class="flex ml-[18px] items-center py-4 px-[18px] justify-center space-x-1 h-[36px] bg-selectBg rounded-sm"
      >
        <!-- selected text -->
        <span
          class="font-semibold h-[14px] text-white text-small font-sofia leading-full"
          >Technologie</span
        >
        <!-- button -->
        <svg
      ...
      <div class="flex items-center justify-end px-[17.52px] w-full">
        ...
        <!-- End link user profil -->

        <div v-if="$session.loggedIn" class="flex items-center ml-[8px] space-x-[3px]">
