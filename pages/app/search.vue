<template>
  <div class="relative h-screen pt-[165px] bg-background">
    <search-bar />
    <div
      class="flex flex-col font-paralucent text-white pl-[20.1px] pr-[25.69px]"
    >
      <div class="flex flex-col space-y-[12.56px]">
        <div class="flex">
          <p class="font-bold text-[22.6137px] leading-input">
            Mes radios récentes
          </p>
        </div>
        <div class="flex flex-col space-y-[12.56px] w-full items-start">
          <nuxt-link
            to="/app/profil"
            v-for="item in recentRadios"
            :key="item.url"
            class="flex items-center justify-between w-full"
          >
            <p
              class="font-normal font-paralucent capitalize text-[15.0758px] leading-md"
            >
              {{ item.name }}
            </p>
            <div
              class="h-[32px] w-[32px] relative rounded-full flex items-center justify-center"
            >
              <nuxt-img
                loading="lazy"
                alt="user-profile"
      ...
      <div class="flex flex-col space-y-[30.15px] pt-[52.77px]">
        <div class="flex">
          <p class="font-bold text-[22.6137px] leading-input">
            Resultat pour : Sankara
          </p>
        </div>
        <div
        ...
        >
          ...
          >
            <div
              class="h-[80px] !w-[80px] !min-w-[80px] !max-w-[80px] object-contain bg-center bg-cover rounded-[12px] flex justify-center items-center"
      ...
      results: [
        {
          ...
          id: "",
          active: true,
          url: "https://images.unsplash.com/photo-1531256456869-ce942a665e80?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop",
        },
        {
          title: "Musala Ya Internet",
          description:
